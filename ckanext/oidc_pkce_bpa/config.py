...
CONFIG_BASE_URL = "ckanext.oidc_pkce_bpa.base_url"
CONFIG_CLIENT_ID = "ckanext.oidc_pkce_bpa.client_id"
CONFIG_CLIENT_SECRET = "ckanext.oidc_pkce_bpa.client_secret"

CONFIG_AUTH_PATH = "ckanext.oidc_pkce_bpa.auth_path"
DEFAULT_AUTH_PATH = "/oauth2/default/v1/authorize"

CONFIG_TOKEN_PATH = "ckanext.oidc_pkce_bpa.token_path"
DEFAULT_TOKEN_PATH = "/oauth2/default/v1/token"

CONFIG_USERINFO_PATH = "ckanext.oidc_pkce_bpa.userinfo_path"
DEFAULT_USERINFO_PATH = "/oauth2/default/v1/userinfo"

CONFIG_REDIRECT_PATH = "ckanext.oidc_pkce_bpa.redirect_path"
DEFAULT_REDIRECT_PATH = "/user/login/oidc-pkce/callback"

CONFIG_LOGOUT_PATH = "ckanext.oidc_pkce_bpa.logout_path"
DEFAULT_LOGOUT_PATH = ""

CONFIG_ERROR_REDIRECT = "ckanext.oidc_pkce_bpa.error_redirect"
DEFAULT_ERROR_REDIRECT = None

CONFIG_SCOPE = "ckanext.oidc_pkce_bpa.scope"
DEFAULT_SCOPE = "openid email profile"

CONFIG_SAME_ID = "ckanext.oidc_pkce_bpa.use_same_id"
DEFAULT_SAME_ID = False

CONFIG_MUNGE_PASSWORD = "ckanext.oidc_pkce_bpa.munge_password"
