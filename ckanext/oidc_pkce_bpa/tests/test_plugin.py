...
from ckanext.oidc_pkce_bpa import plugin as plugin_module
...
if p.toolkit.check_ckan_version('2.10'):
    ...
    @pytest.mark.ckan_config("ckanext.oidc_pkce_bpa.base_url", "http://unit-test-sso")
    @pytest.mark.ckan_config("ckanext.oidc_pkce_bpa.logout_path", "/logout")
    ...
    @pytest.mark.ckan_config("ckanext.oidc_pkce_bpa.base_url", "http://unit-test")
